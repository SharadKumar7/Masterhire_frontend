...
const SearchJob = () => {
  ...
  const activeChips = [
    ...
    filters.clientHistory !== "All" && {
      key: "clientHistory",
      label: "Client",
      value: filters.clientHistory,
    },
    filters.price !== "All" && {
      key: "price",
      label: "Budget",
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search by title, skill, keyword, or Job ID (e.g. JOB-345)..."
            value={searchQuery}
          ...
          <div className="space-y-4">
            {currentItems.map((item) => (
              <div
                key={item._id}
                onClick={() =>
                  navigate(`/freelancer/dashboard/applications/${item._id}`)
                }
