...
import FreelancerDetailsSection    from "./WorkspaceDetailsSection";
import FreelancerMilestonesSection from "./MilestonesSection";
...
const FreelancerWorkspace = () => {
  ...
  const fetchJob = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await apiFetch(`/api/freelancer/job-details/${projectId}`);
      setData({ ...res.job });
    } catch (e) {
      setError(e.message);
    } finally {
